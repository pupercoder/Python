# import the libraries to use in code 

import csv
import re
from sys import argv, exit

# if loop to open and use the txt file 
...
# match the patterns 
# made by pupercoder 
# use databases and search for patterns and matches 
    ...
    for i, row in enumerate(database_reader):
        if i == 0:
            ...
            if list_database_strs == longest_strs:
                print(row[0])
                break
# print the output for when there are no matches 
    else:
        print("No match")